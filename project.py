...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Have The World Clock With Only 2 Command Line Arguments! Don't Have Time To Read It On Your Screen? No Worries!, I Got You Covered With Text To Speech Feature!")
    parser.add_argument(
